 ...
 * @author securonix
 */
@WebServlet(name = "ModifyProperties", urlPatterns = {"/ModifyProperties"})
public class ModifyProperties extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String tranid = request.getParameter("userNumber");
        String action = request.getParameter("action");
        MySqlDatabase mydb = new MySqlDatabase();
        boolean result = false;
        if(action.contains("yes"))
            result = mydb.updateApproval(Integer.parseInt(tranid));
        else if(action.contains("no"))
            result = mydb.deleteOrder(Integer.parseInt(tranid));
