...
function onButtonClick(){
  ...
  $.post("http://localhost:8080/FeedGeneratorUI/authenticate", {username: username, password: passhash.toString()}, function(data){
    if(data == "loggedin"){
      window.location.href = "http://localhost:8080/FeedGeneratorUI/InputRequestParameters.jsp";
    }else{
